...
<head>
    ...
    <title>Wisata Sejarah - Login</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{asset('css/login_ver/WisataSejarah_Login.css')}}">
    ...
    <section class="isi">
        ...
        <div class="SpaceIsiAtas">
            <div class="space_judul">
                <h1 class="JudulAlam">WISATA SEJARAH</h1>
            </div>
        ...
        <a href="/SejarahJakarta_Login">
          <div class="image-container">
            <img src="./Images/SejarahJakarta.png" alt="">
            <div class="image-text">JAKARTA</div>
          </div>
        </a>
        
        <a href="/SejarahBogor_Login">
          <div class="image-container">
            <img src="./Images/SejarahBogor.png" alt="">
            <div class="image-text">BOGOR</div>
          </div>
        </a>
        
        <a href="/SejarahBandung_Login">
          <div class="image-container">
            <img src="./Images/SejarahBandung.png" alt="">
