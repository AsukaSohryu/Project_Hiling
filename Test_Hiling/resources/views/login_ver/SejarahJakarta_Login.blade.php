...
<head>
    ...
    <title>Wisata Sejarah Jakarta - Login</title>
    ...
    <section class="isi">
        ...
        <div class="SpaceIsiAtas">
            <div class="space_judul">
                <h1 class="JudulAlam">WISATA SEJARAH JAKARTA</h1>
            </div>
        ...
        <container id="container">
          <section id ="wisata">
              ...
              <div class id ="caption">
                  <div class id="deskripsi">
                      ...
                      <h3>Rating 4.6/5 <span id="titik">●</span> Jl. Medan Merdeka Barat No.12, Gambir, Kecamatan Gambir, Kota Jakarta Pusat</h3>
                      <h4>Buka <span id="titik">●</span> Everyday: 09:00 - 16:00 </h4>
                      <h5>Museum Nasional Indonesia, atau yang sering disebut dengan Museum Gajah, adalah sebuah museum arkeologi, sejarah, etnografi, dan geografi yang terletak di Jakarta Pusat dan persisnya di Jalan Merdeka Barat 12. Museum ini merupakan museum pertama dan terbesar di Asia Tenggara.</h5>
                  </div>
                  <div class id="tiket">
                      <h2>Terjual</h2>
          ...
          <section id ="wisata">
            ...
            <div class id ="caption">
                <div class id="deskripsi">
                    <h1>Musem Bank Indonesia</h1>
                    <h3>Rating 4.3/5 <span id="titik">●</span> Jl. Pintu Besar Utara No.3, RW.6, Pinangsia, Kec. Taman Sari, Kota Jakarta Barat</h3>
                    <h4>Buka <span id="titik">●</span> Everyday: 08:30 - 15:30 </h4>
                    <h5>Museum BI menempati gedung BI Kota yang sebelumnya digunakan oleh De Javasche Bank, gedung yang mempunyai nilai sejarah yang tinggi. Pelestarian gedung BI Kota sejalan dengan kebijakan Pemerintah DKI Jakarta yang mencanangkan daerah Kota Tua sebagai salah satu daerah bersejarah di Jakarta.</h5>
                </div>
                <div class id="tiket">
                    <h2>Terjual</h2>
        ...
        <section id ="wisata">
          ...
          <div class id ="caption">
              <div class id="deskripsi">
                  <h1>Museum Wayang</h1>
                  <h3>Rating 4.4/5 <span id="titik">●</span> Jalan Pintu Besar Utara No.27 Pinangsia, RT.3/RW.6, Kota Tua, Kec. Taman Sari, Kota Jakarta Barat</h3>
                  <h4>Buka <span id="titik">●</span> Everyday: 09:00 - 18:00 </h4>
                  <h5>Museum Wayang adalah sebuah museum yang berlokasi di Jalan Pintu Besar Utara Nomor 27, Jakarta Barat. Museum Wayang memamerkan berbagai jenis dan bentuk wayang dari seluruh Indonesia, baik yang terbuat dari kayu dan kulit maupun bahan-bahan lain. </h5>
              </div>
              <div class id="tiket">
                  <h2>Terjual</h2>
