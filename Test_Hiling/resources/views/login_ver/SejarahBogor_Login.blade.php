...
<head>
    ...
    <title>Wisata Sejarah Bogor - Login</title>
    ...
    <section class="isi">
        ...
        <div class="SpaceIsiAtas">
            <div class="space_judul">
                <h1 class="JudulAlam">WISATA SEJARAH BOGOR</h1>
            </div>
        ...
        <container id="container">
          <section id ="wisata">
              <div class="gambar">
                  <img width=45% src="./Images/WisataSejarahBogor/istanabogor1.png" id="gambar1">
                  <img width=23.5% src="./Images/WisataSejarahBogor/istanabogor2.png" id="gambar2">
                  <img width=23.5% src="./Images/WisataSejarahBogor/istanabogor3.png" id="gambar2">
              </div>
              <div class id ="caption">
                  <div class id="deskripsi">
                      <h1>Istana Bogor</h1>
                      <h3>Rating 4.6/5 <span id="titik">●</span> Jl. Ir. H. Juanda No. 13, Bogor,</h3>
                      <h4>Buka <span id="titik">●</span> Everyday: 08:00 - 15:00 </h4>
                      <h5>Istana Bogor, juga dikenal sebagai Istana Kepresidenan Bogor atau Istana Bogor, adalah kediaman resmi Presiden Indonesia saat berada di Bogor. Bangunan istana ini memiliki sejarah panjang dan berasal dari masa kolonial Belanda. Anda dapat menjelajahi taman yang luas di sekitar istana dan melihat keindahan arsitektur serta koleksi seni yang ada di dalamnya.</h5>
                  </div>
                  <div class id="tiket">
                      <h2>Terjual</h2>
          ...
          <section id ="wisata">
            <div class="gambar">
                <img width=45% src="./Images/WisataSejarahBogor/museumperjuangan1.png" id="gambar1">
                <img width=23.5% src="./Images/WisataSejarahBogor/museumperjuangan2.png" id="gambar2">
                <img width=23.5% src="./Images/WisataSejarahBogor/museumperjuangan3.png" id="gambar2">
            </div>
            <div class id ="caption">
                <div class id="deskripsi">
                    <h1>Musem Perjuangan Bogor</h1>
                    <h3>Rating 4.3/5 <span id="titik">●</span>  Jl. Sudirman No. 30, Bogor, Jawa Barat.</h3>
                    <h4>Buka <span id="titik">●</span> Everyday: 08:00 - 16:00 </h4>
                    <h5>Museum Perjuangan Bogor didedikasikan untuk mengenang perjuangan rakyat Bogor dalam memperjuangkan kemerdekaan Indonesia. Museum ini menampilkan koleksi sejarah, artefak, foto, dan dokumen yang berhubungan dengan perjuangan rakyat Bogor selama masa penjajahan Belanda dan perjuangan kemerdekaan. Anda dapat mempelajari lebih lanjut tentang peristiwa sejarah dan tokoh-tokoh yang berperan di Bogor.</h5>
                </div>
                <div class id="tiket">
                    <h2>Terjual</h2>
        ...
        <section id ="wisata">
          <div class="gambar">
              <img width=45% src="./Images/WisataSejarahBogor/megalitikum1.png" id="gambar1">
              <img width=23.5% src="./Images/WisataSejarahBogor/megalitikum2.png" id="gambar2">
              <img width=23.5% src="./Images/WisataSejarahBogor/megalitikum3.png" id="gambar2">
          </div>
          
          <div class id ="caption">
              <div class id="deskripsi">
                  <h1>Situs Megalitikum Gunung Padang</h1>
                  <h3>Rating 4.4/5 <span id="titik">●</span> Kampung Gunung Padang, Desa Karyamukti, Kecamatan Campaka, Kabupaten Cianjur</h3>
                  <h4>Buka <span id="titik">●</span> Everyday: 08:00 - 17:00 </h4>
                  <h5>Situs Megalitikum Gunung Padang terletak di dekat Bogor dan diyakini sebagai kompleks piramida megalitikum yang berusia ribuan tahun. Situs ini menjadi pusat perdebatan dan penelitian arkeologi yang menarik. Anda dapat mengunjungi situs ini dan menjelajahi kompleks batu-batu megah yang ada di sana sambil mempelajari kebudayaan kuno di daerah ini. </h5>
              </div>
              <div class id="tiket">
                  <h2>Terjual</h2>
