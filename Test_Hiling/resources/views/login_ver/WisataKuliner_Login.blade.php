...
<head>
    ...
    <title>Wisata Kuliner - Login</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{asset('css/login_ver/WisataKuliner_Login.css')}}">
    ...
    <section class="isi">
        ...
        <div class="SpaceIsiAtas">
            <div class="space_judul">
                <h1 class="JudulAlam">WISATA KULINER</h1>
            </div>
        ...
        <a href="/KulinerJakarta_Login">
          <div class="image-container">
            <img src="./Images/KulinerJakarta.png" alt="">
            <div class="image-text">JAKARTA</div>
          </div>
        </a>
        
        <a href="/KulinerBogor_Login">
          <div class="image-container">
             <img src="./Images/KulinerBogor.png" alt="">
             <div class="image-text">BOGOR</div>
          </div>
        </a>
        
        <a href="/KulinerBandung_Login">
          <div class="image-container">
            <img src="./Images/KulinerBandung.png" alt="">
