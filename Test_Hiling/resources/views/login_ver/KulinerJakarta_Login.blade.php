...
<head>
    ...
    <title>Wisata Kuliner Jakarta - Login</title>
    ...
    <section class="isi">
        ...
        <div class="SpaceIsiAtas">
            <div class="space_judul">
                <h1 class="JudulAlam">WISATA KULINER JAKARTA</h1>
            </div>
        ...
        <container id="container">
          <section id ="wisata">
              <div class="gambar">
                  <img width=45% src="./Images/WisataKulinerJakarta/Sabang1.png" id="gambar1">
                  <img width=23.5% src="./Images/WisataKulinerJakarta/sabang2.png" id="gambar2">
                  <img width=23.5% src="./Images/WisataKulinerJakarta/sabang3.png" id="gambar2">
              </div>
              <div class id ="caption">
                  <div class id="deskripsi">
                      <h1>Jalan Sabang</h1>
                      <h3>Rating 4.6/5 <span id="titik">●</span> Jalan Haji Agus Salim</h3>
                      <h4>Buka <span id="titik">●</span> - </h4>
                      <h5>Jalan Sabang terletak di pusat Kota Jakarta, dekat dengan kawasan wisata Monas. Jalan ini terkenal sebagai surga makanan jalanan. Anda dapat menemukan beragam hidangan lezat seperti nasi goreng, mie goreng, sate, gado-gado, bakso, dan masih banyak lagi. Suasana yang ramai dan banyaknya pilihan makanan yang tersedia membuat Jalan Sabang menjadi tempat yang populer bagi pecinta kuliner.</h5>
                  </div>
                  <div class id="tiket">
                      <h2>Terjual</h2>
          ...
          <section id ="wisata">
            <div class="gambar">
                <img width=45% src="./Images/WisataKulinerJakarta/mabes1.png" id="gambar1">
                <img width=23.5% src="./Images/WisataKulinerJakarta/mabes2.png" id="gambar2">
                <img width=23.5% src="./Images/WisataKulinerJakarta/mabes3.png" id="gambar2">
            </div>
            <div class id ="caption">
                <div class id="deskripsi">
                    <h1>Jalan Mangga Besar</h1>
                    <h3>Rating 4.7/5 <span id="titik">●</span> Kabupaten Bandung Barat</h3>
                    <h4>Buka <span id="titik">●</span> - </h4>
                    <h5>Jalan Mangga Besar terletak di daerah Mangga Besar, Jakarta Barat. Jalan ini terkenal dengan kelezatan makanan Tionghoa dan juga hidangan laut. Anda dapat menikmati hidangan seperti kepiting saus tiram, cumi goreng tepung, ikan bakar, mie ayam, dan masih banyak lagi. Jalan Mangga Besar juga dikenal dengan kehidupan malamnya yang meriah, dengan banyaknya restoran dan klub malam yang menjadi favorit pengunjung.</h5>
                </div>
                <div class id="tiket">
                    <h2>Terjual</h2>
                    <h3><img src="./Images/Logo Tiket.png" id="icon-ticket"> - RB</h3>
        ...
        <section id ="wisata">
          <div class="gambar">
              <img width=45% src="./Images/WisataKulinerJakarta/santa1.png" id="gambar1">
              <img width=23.5% src="./Images/WisataKulinerJakarta/santa2.png" id="gambar2">
              <img width=23.5% src="./Images/WisataKulinerJakarta/santa3.png" id="gambar2">
          </div>
          
          <div class id ="caption">
              <div class id="deskripsi">
                  <h1>Pasar Santa</h1>
                  <h3>Rating 4.6/5 <span id="titik">●</span> Jl Cisanggiri II, Santa, Kebayoran Baru, Jakarta Selatan</h3>
                  <h4>Buka <span id="titik">●</span> -</h4>
                  <h5>Pasar Santa terletak di daerah Kebayoran Baru, Jakarta Selatan. Pasar ini adalah tempat yang populer bagi pecinta makanan kreatif dan unik. Di sini, Anda dapat menemukan berbagai jenis makanan street food, makanan organik, kue-kue homemade, kopi spesial, es krim unik, dan masih banyak lagi. Pasar Santa juga memiliki suasana yang santai dan cocok untuk bersantai sambil menikmati hidangan lezat.</h5>
              </div>
              <div class id="tiket">
                  <h2>Terjual</h2>
                  <h3><img src="./Images/Logo Tiket.png" id="icon-ticket"> - RB</h3>
