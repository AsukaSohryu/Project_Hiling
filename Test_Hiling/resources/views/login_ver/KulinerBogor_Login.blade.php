...
<head>
    ...
    <title>Wisata Kuliner Bogor - Login</title>
    ...
    <section class="isi">
        ...
        <div class="SpaceIsiAtas">
            <div class="space_judul">
                <h1 class="JudulAlam">WISATA KULINER BOGOR</h1>
            </div>
        ...
        <container id="container">
          <section id ="wisata">
              <div class="gambar">
                  <img width=45% src="./Images/WisataKulinerBogor/puncakpass1.png" id="gambar1">
                  <img width=23.5% src="./Images/WisataKulinerBogor/puncakpass2.png" id="gambar2">
                  <img width=23.5% src="./Images/WisataKulinerBogor/puncakpass3.png" id="gambar2">
              </div>
              <div class id ="caption">
                  <div class id="deskripsi">
                      <h1>Puncak Pass</h1>
                      <h3>Rating 4.6/5 <span id="titik">●</span> Jl. Raya Puncak KM. 90, Sindanglaya, Cianjur, Tugu Selatan, Cisarua, Tugu Sel., Kec. Cisarua, Bogor</h3>
                      <h4>Buka <span id="titik">●</span> - </h4>
                      <h5>Puncak Pass merupakan daerah perbukitan yang terletak di Bogor, Jawa Barat, dan terkenal dengan pemandangan alam yang indah. Selain keindahan alamnya, Puncak Pass juga menawarkan berbagai tempat makan yang menghidangkan makanan tradisional dan internasional. Anda dapat menikmati hidangan lezat sambil menikmati pemandangan pegunungan yang memukau.</h5>
                  </div>
                  <div class id="tiket">
                      <h2>Terjual</h2>
          ...
          <section id ="wisata">
            <div class="gambar">
                <img width=45% src="./Images/WisataKulinerBogor/satekelinci1.png" id="gambar1">
                <img width=23.5% src="./Images/WisataKulinerBogor/satekelinci2.png" id="gambar2">
                <img width=23.5% src="./Images/WisataKulinerBogor/satekelinci3.png" id="gambar2">
            </div>
            <div class id ="caption">
                <div class id="deskripsi">
                    <h1>Kuliner Sate Kelinci</h1>
                    <h3>Rating 4.7/5 <span id="titik">●</span> Bogor</h3>
                    <h4>Buka <span id="titik">●</span> - </h4>
                    <h5>Sate Kelinci adalah salah satu ikon kuliner Bogor. Sate kelinci dihidangkan dengan bumbu kacang yang khas dan disajikan dengan lontong atau nasi. Selain sate kelinci, Anda juga dapat menemukan variasi sate lainnya seperti sate ayam, sate kambing, dan sate sapi. Rasakan cita rasa yang unik dan nikmati pengalaman makan yang berbeda di Sate Kelinci</h5>
                </div>
                <div class id="tiket">
                    <h2>Terjual</h2>
                    <h3><img src="./Images/Logo Tiket.png" id="icon-ticket"> - RB</h3>
        ...
        <section id ="wisata">
          <div class="gambar">
              <img width=45% src="./Images/WisataKulinerBogor/cimory1.png" id="gambar1">
              <img width=23.5% src="./Images/WisataKulinerBogor/cimory2.png" id="gambar2">
              <img width=23.5% src="./Images/WisataKulinerBogor/cimory3.png" id="gambar2">
          </div>
          
          <div class id ="caption">
              <div class id="deskripsi">
                  <h1>Cimory Mountain View</h1>
                  <h3>Rating 4.6/5 <span id="titik">●</span> Jalan Raya Puncak-Cianjur KM 77, No.415, Leuwimalang, Cisarua, Bogor.</h3>
                  <h4>Buka <span id="titik">●</span> Everyday: 10.00 - 22.00</h4>
                  <h5>Ingin kulineran sambil menikmati pemandangan yang indah bersama keluarga tercinta? Cimory Mountain View solusinya. Restoran ini cukup terkenal di Puncak Bogor sana karena tidak hanya menyuguhkan makanan yang lezat, tapi juga memiliki panorama alam memukau dengan udara yang sejuk. Poin plusnya lagi, restoran milik PT. Cimory ini juga menyediakan taman bermain untuk anak yang cocok sebagai destinasi wisata keluarga.</h5>
              </div>
              <div class id="tiket">
                  <h2>Terjual</h2>
                  <h3><img src="./Images/Logo Tiket.png" id="icon-ticket"> - RB</h3>
