...
<head>
    ...
    <title>TentangKami-Login</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{asset('css/login_ver/TentangKamiLogin.css')}}">
...
<body>
        ...
        <section class="isi">
          <div class="isi_tentangkami">
              <h1 class="header_about">Tentang Kami</h1>
              <img class="img_about" src="./Images/gunung2.png" alt="TentangKamiGbr">
              <br><br><br>
              <h1 class="Quotes_TentangKami">“Hiling bukanlah pilihan, melainkan kebutuhan”</h1>
              <br><br>
              
              <p class="paragraf_about">Hiling merupakan sebuah website informatif yang memiliki tujuan untuk membantu mengenalkan UMKM dan Pariwisata Indonesia serta memudahkan masyarakat yang ingin melakukan kunjungan ke tempat destinasi dengan menyediakan berbagai fitur pendukung.
                <br><br><br> Keamanan jasa yang diberikan Hiling menjadikan kegiatan wisata di Indonesia menjadi lebih terjamin,  aman dan menyenangkan </p>
          </div>
      </section>
