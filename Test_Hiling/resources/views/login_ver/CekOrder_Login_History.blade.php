...
<head>
    ...
    <title>CekOrder-Login-History</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{asset('css/login_ver/CekOrder_Login_History.css')}}">
              ...
              <div class="container-fluid">
                <a class="navbar-brand" href="/homepage"><img src="./Images/logobiru.png" alt="Logo" width="246" height="73.87" class="d-inline-block align-text-top"></a>
                  ...
                  <ul class="nav nav-pills nav justify-content-end">
                      ...
                      <li class="nav-item">
                          <a class="nav-link active" href="/CekOrder_Login_History">Cek Order</a>
                      </li>
                      <li class="nav-item">
