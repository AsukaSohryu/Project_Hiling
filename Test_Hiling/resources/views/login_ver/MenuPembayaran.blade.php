...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/login_ver/MenuPembayaran.css')}}">
        ...
        <section class="isi">
            <div class="spaceisi">
                <div class="header">
                    ...
                    <div class="garisheader"></div>
                </div>

                <div class="space_deskripsi">
                    <div class="deskripsiBarang">
                        <div width="10%" class="barang"><h2>Barang</h2></div>
                        <div class="desKanan">
                            <div class="item1"><h2>Harga</h2></div>
                            <div class="item1"><h2>Jumlah</h2></div>
                            <div class="item2"><h2>Total</h2></div>
                        </div>
                    ...
                    <div class="deskripsiBarang">
                      <div class="desKiri">
                          <div class="deskTiket">
                            <img class="logoTiket" src="./Images/Logo_Tiket.png" alt="">
                            <div class="isiTiket">
                              <h2 class="nama">Tiket Tiga Kali Main</h2>
                              <h4 class="atas">Kategori:</h4>
                              <h4 class="bawah">Wahana Gravity Lugs Lembang</h4>
                              <h4 class="atas">Tanggal Pesanan: </h4>
                              <h4 class="bawah">22 Mei 2023</h4>
                            </div>
                          </div>
                      </div>
                      <div class="desKanan">
                          <div class="desk1">IDR 120.000,00</div>
                          <div class="desk1">2</div>
                          <div class="desk2">IDR 240.000,00</div>
                      </div>
                    </div>
                    ...
                    <div class="Total">
                      <div class="desTotal">
                        <div class="item">
                          <div class="total1">Total Produk</div>
                          <div class="total1">IDR 240.000,00</div>
                        </div>
                        <div class="item">
                          <div class="total1">Potongan Harga</div>
                          <div class="total1">IDR 0</div>
                        </div>
                        <div class="item">
                          <div class="total1">Fee Aplikasi (4%)</div>
                          <div class="total1">IDR 9.600,00</div>
                        </div>
                        ...
                        <div class="item">
                          ...
                          <div class="total2">IDR 249.600,00</div>
                        </div>
                      </div>
                    ...
                    <div class="metodePembayaran">
                      <div class="headermetode">Metode Pembayaran</div>
                      <div class="buttonPembayaran">
                        
                        <div class="tombol">
                          <button type="button" class="btn btn-light">Transfer Virtual Account BCA <img src="./Images/bca.png" alt=""></button>
                          <button type="button" class="btn btn-light">
                            <div class="text">DANA</div> 
                        ...
                        <div class="tombol">
                          <button type="button" class="btn btn-light">
                            <div class="text">Gopay</div> 
                            <img src="./Images/gopay.png" alt="">
                          </button>
                          <button type="button" class="btn btn-light">
                            <div class="text">OVO</div> 
                            <img src="./Images/ovo.png" alt="">
                          </button>
                        </div>

                      </div>
                      <a href="/CekOrder_Login_History" type="submit" class="btn btn-primary">Bayar</a>
                    </div>
