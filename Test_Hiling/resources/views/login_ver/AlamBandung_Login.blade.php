...
<head>
    ...
    <title>Wisata Alam Bandung - Login</title>
    ...
    <section class="isi">
        ...
        <div class="SpaceIsiAtas">
            <div class="space_judul">
                <h1 class="JudulAlam">WISATA ALAM BANDUNG</h1>
            </div>
        ...
        <container id="container">
          <section id ="wisata">
              <div class="gambar">
                  <img width=45% src="./Images/WisataAlamBandung/kawahputih1.png" id="gambar1">
                  <img width=23.5% src="./Images/WisataAlamBandung/kawahputih2.png" id="gambar2">
                  <img width=23.5% src="./Images/WisataAlamBandung/kawahputih3.png" id="gambar2">
              </div>
              <div class id ="caption">
                  <div class id="deskripsi">
                      <h1>Kawah Putih Ciwidey</h1>
                      <h3>Rating 4.5/5 <span id="titik">●</span> Ciwidey, Jawa Barat, 50KM Arah Selatan Kota Bandung</h3>
                      <h4>Buka <span id="titik">●</span> Everyday: 07:30 - 16:30</h4>
                      <h5>Kawah Putih Ciwidey merupakan salah satu destinasi wisata terpopuler di Bandung. Berlokasi sekitar 50 kilometer selatan Bandung di Jawa Barat, Kawah Putih Ciwidey menyediakan fasilitas untuk menikmati pemandian air panas, mencoba makanan khas Bandung, berfoto, dan menikmati panorama yang indah.</h5>
                  </div>
                  <div class id="tiket">
                      <h2>Terjual</h2>
                      <h3><img src="./Images/Logo Tiket.png" id="icon-ticket"> 9 RB</h3>
                      <h4>Kali</h4>
                      <h5>Mulai Dari:</h5>
                      <h6>IDR 28.000,00</h6>
                  </div>
          ...
          <section id ="wisata">
            <div class="gambar">
                <img width=45% src="./Images/WisataAlamBandung/tamanjuanda1.png" id="gambar1">
                <img width=23.5% src="./Images/WisataAlamBandung/tamanjuanda2.png" id="gambar2">
                <img width=23.5% src="./Images/WisataAlamBandung/tamanjuanda3.png" id="gambar2">
            </div>
            <div class id ="caption">
                <div class id="deskripsi">
                    <h1>Taman Hutan Raya Ir. Juanda</h1>
                    <h3>Rating 4.6/5 <span id="titik">●</span> Kompleks Tahura, Jl. Ir. H. Juanda No.99, Ciburial, Kec. Cimenyan, Kabupaten Bandung</h3>
                    <h4>Buka <span id="titik">●</span> Everyday: 08:00 - 16:00</h4>
                    <h5>Taman Hutan Raya Ir. H. Djuanda (Tahura Djuanda) merupakan kawasan konservasi yang terpadu antara alam sekunder dengan hutan tanaman dengan jenis Pinus (Pinus merkusil) yang terletak di Sub-Daerah Aliran Sungai Cikapundung dan DAS Citarum yang membentang mulai dari Curug Dago, Dago Pakar sampai Curug Maribaya yang merupakan bagian dari kelompok hutan Gunung Pulosari.</h5>
                </div>
                <div class id="tiket">
                    <h2>Terjual</h2>
        ...
        <section id ="wisata">
          <div class="gambar">
              <img width=45% src="./Images/WisataAlamBandung/stonegarden1.png" id="gambar1">
              <img width=23.5% src="./Images/WisataAlamBandung/stonegarden2.png" id="gambar2">
              <img width=23.5% src="./Images/WisataAlamBandung/stonegarden3.png" id="gambar2">
          </div>
          
          <div class id ="caption">
              <div class id="deskripsi">
                  <h1>Stone Garden Citatah</h1>
                  <h3>Rating 4.4/5 <span id="titik">●</span> Gunung Masigit, Citatah, Kec. Cipatat, Kabupaten Bandung Barat</h3>
                  <h4>Buka <span id="titik">●</span> Everyday: 05:30 - 18:00</h4>
                  <h5>Stone Garden adalah sebuah kawasan karst seluas dua hektar dengan batu gamping artistik yang letaknya 908 meter diatas permukaan laut yaitu puncak Gunung Pawon, Kampung Girimulya, Desa Gunung Masigit, Kecamatan Cipatat, Kabupaten Bandung Barat. Destinasi ini menawarkan pegunungan hijau sebagai pemandangan  sekitarnya dari puncak bukit berbatu.</h5>
              </div>
              <div class id="tiket">
                  <h2>Terjual</h2>
