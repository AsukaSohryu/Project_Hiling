...
<head>
    ...
    <title>Wisata Wahana Bandung - Login</title>
    ...
    <section class="isi">
        ...
        <div class="SpaceIsiAtas">
            <div class="space_judul">
                <h1 class="JudulAlam">WISATA WAHANA BANDUNG</h1>
            </div>
        ...
        <container id="container">
          <section id ="wisata">
              <div class="gambar">
                  <img width=45% src="./Images/WisataWahanaBandung/grafting1.png" id="gambar1">
                  <img width=23.5% src="./Images/WisataWahanaBandung/grafting2.png" id="gambar2">
                  <img width=23.5% src="./Images/WisataWahanaBandung/grafting3.png" id="gambar2">
              </div>
              <div class id ="caption">
                  <div class id="deskripsi">
                      <h1>G Rafting Arum Jeram</h1>
                      <h3>Rating 4.6/5 <span id="titik">●</span> Sungai Palayangan Pangalengan, Bandung</h3>
                      <h4>Buka <span id="titik">●</span> Everyday: 10:00 - 18:00 </h4>
                      <h5>Pengalaman rafting arum jeram di Sungai Palayangan dengan jarak 5KM dan waktu tempuh 90 Menit. Paket termasuk Welcome drink, Makan berat 1x, Snack, P3K / Safety Equipment & Rescue team, Rest Area, Tempat Bilas, Asuransi, Local transport, Instruktur. Buruan tunggu apa lagi?</h5>
                  </div>
                  <div class id="tiket">
                      <h2>Terjual</h2>
          ...
          <section id ="wisata">
            <div class="gambar">
                <img width=45% src="./Images/WisataWahanaBandung/rainbowslide1.png" id="gambar1">
                <img width=23.5% src="./Images/WisataWahanaBandung/rainbowslide2.png" id="gambar2">
                <img width=23.5% src="./Images/WisataWahanaBandung/rainbowslide3.png" id="gambar2">
            </div>
            <div class id ="caption">
                <div class id="deskripsi">
                    <h1>Rainbow Slide</h1>
                    <h3>Rating 4.3/5 <span id="titik">●</span> Kabupaten Bandung Barat</h3>
                    <h4>Buka <span id="titik">●</span> Everyday: 10:00 - 17:00 </h4>
                    <h5>Tempat wisata baru di Kabupaten Bandung Barat, Rainbow Slide, memiliki konsep tempat wisata bermain untuk anak dan keluarga di Lembang yang unik. Tempat wisata yang peresmiannya di buka pada tanggal 29 April 2022 yang lalu ini menawarkan wahana bermain berupa tempat perosotan yang dibuat dengan warna – warni</h5>
                </div>
                <div class id="tiket">
                    <h2>Terjual</h2>
        ...
        <section id ="wisata">
          <div class="gambar">
              <img width=45% src="./Images/WisataWahanaBandung/lugsgravity1.png" id="gambar1">
              <img width=23.5% src="./Images/WisataWahanaBandung/lugsgravity2.png" id="gambar2">
              <img width=23.5% src="./Images/WisataWahanaBandung/lugsgravity3.png" id="gambar2">
          </div>
          
          <div class id ="caption">
              <div class id="deskripsi">
                  <h1>Lugs Gravity Lembang</h1>
                  <h3>Rating 4.6/5 <span id="titik">●</span> Mendulang Resort & Resto, Jl. Pabrik Gitar, Pagerwangi, Kec. Lembang, Kabupaten Bandung Barat,</h3>
                  <h4>Buka <span id="titik">●</span> Everyday: 08:00 - 17:00 </h4>
                  <h5>Wahana Gravity Luge adalah wahana yang menggunakan kendaraan dengan seluncuran tanpa mesin penggerak, alias memanfaatkan gravitasi dan turunan untuk melaju. Berbagai keseruan dan adrenalin dapat dirasakan pada lintasan sejauh 750 M! nantikan apa lagi ayo rasakan sekarang!</h5>
              </div>
              <div class id="tiket">
                  <h2>Terjual</h2>
          ...
          <div class="Lihatinfo">
            <a href="/LugsGravityLembang_Login" type="button" class="btn btn-light">Lihat Informasi</a>
          </div>
