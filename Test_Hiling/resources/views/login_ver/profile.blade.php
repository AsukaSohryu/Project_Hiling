...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/login_ver/profile.css')}}">
...
<body>
    ...
    <section id="profilecontainer">
      <section id ="kiri">
          ...
          <div class id="profil">
                  <div class="spaceprofil">
                      <img src="./Images/profilepic.jpg" id="profilepic">
                  </div>
  
                  <h1>{{Auth::user()->name}}</h1>
                  <h2><b>Status:</b> Terverifikasi</h2>
                  <h2><b>Total Point:</b> 10.000</h2>
  
                  <h3>Akun</h3>
                  <a href="/CekOrder_Login_History"><h4>Cek Order</h4></a>
                  <h4>Hiling Rewards</h4>
                  <h4>My Review</h4>
      ...
      <section id="detail">
        <form action="{{route('EditProfile')}}" method="post">
          @csrf 
          @method('PATCH')
            <div class id="profilform">
            <h1>Detail Akun</h1>
            <label>Nama Lengkap</label>
            <input type="text" id="name" class="input" name="name" value="{{$user->name}}"><br>
            <label>Email</label>
            <input type="email" id="email" class="input" name="email" value="{{$user->email}}"><br>
            <label>Nomor Ponsel</label>
            <input type="text" id="name" class="input" name="phone" value="{{$user->phone}}"><br>
            <label>Kata Sandi</label>
            <input type="password" id="password" class="input" name="password"><br>
            <!-- <button type="submit" value="Simpan Perubahan" class="btn"> -->
