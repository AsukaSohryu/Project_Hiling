...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/login_ver/EditProfileSuccess.css')}}">
...
<body>
    ...
    <div class="cs">
        <img class="customer_service" src="./Images/ThumbsUp.png">
    </div>
    <div class="warning">
        <h1 class="warning-text">Profilemu sudah terupdate lho!!</h1>
    </div>
    <div class="warning-button">
        <a href="/homepage" type="button" class="btn btn-primary btn-lg">Kembali ke Home</a>
    </div>
    <!-- Footer -->
    <footer
