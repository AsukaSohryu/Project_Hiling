    ...
    <section class="isi">
        ...
        <div class="SpaceIsiAtas">
            <div class="space_judul">
                <h1 class="JudulAlam">WISATA ALAM BOGOR</h1>
            </div>
        ...
        <container id="container">
          <section id ="wisata">
              <div class="gambar">
                  <img width=45% src="./Images/WisataAlamBogor/leuwi1.png" id="gambar1">
                  <img width=23.5% src="./Images/WisataAlamBogor/leuwi2.png" id="gambar2">
                  <img width=23.5% src="./Images/WisataAlamBogor/leuwi3.png" id="gambar2">
              </div>
              <div class id ="caption">
                  <div class id="deskripsi">
                      <h1>Leuwi Balong Endah</h1>
                      <h3>Rating 4.6/5 <span id="titik">●</span> Kawasan Wisata Gunung Salak Endah Pasir Lenyit, Jl. Curug Pangeran, Kec. Pamijahan, Bogor</h3>
                      <h4>Buka <span id="titik">●</span> Everyday: 07:00 - 17:00</h4>
                      <h5>Berlokasi di wilayah Gunung Salak, Curug Leuwi Balong Endah menyediakan air terjun dan kolam alami yang tidak kalah menarik di lingkungan Jabodetabek. Cocok menjadi destinasi bagi pencinta alam dan tempat liburan keluarga yang mengasyikan!</h5>
                  </div>
                  <div class id="tiket">
                      <h2>Terjual</h2>
                      <h3><img src="./Images/Logo Tiket.png" id="icon-ticket"> 7 RB</h3>
                      <h4>Kali</h4>
                      <h5>Mulai Dari:</h5>
                      <h6>IDR 10.000,00</h6>
          ...
          <section id ="wisata">
            <div class="gambar">
                <img width=45% src="./Images/WisataAlamBogor/pinus1.png" id="gambar1">
                <img width=23.5% src="./Images/WisataAlamBogor/pinus2.png" id="gambar2">
                <img width=23.5% src="./Images/WisataAlamBogor/pinus3.png" id="gambar2">
            </div>
            <div class id ="caption">
                <div class id="deskripsi">
                    <h1>Hutan Pinus Gunung Pancar</h1>
                    <h3>Rating 4.1/5 <span id="titik">●</span> Kp. Karang Tengah Kecamatan Babakan Madang, Bogor.</h3>
                    <h4>Buka <span id="titik">●</span> Everyday: 00:01 - 23:59</h4>
                    <h5>Hutan Pinus Gunung Pancar berlokasi di Sentul merupakan tempat rekreasi yang menawarkan berbagai fasilitas untuk spot foto, berkemah, dan outbound. Saksikan keindahan alam yang cocok untuk liburan keluarga.</h5>
                </div>
                <div class id="tiket">
                    <h2>Terjual</h2>
                    <h3><img src="./Images/Logo Tiket.png" id="icon-ticket"> 6 RB</h3>
                    <h4>Kali</h4>
                    <h5>Mulai Dari:</h5>
                    <h6>IDR 5.000,00</h6>
        ...
        <section id ="wisata">
          <div class="gambar">
              <img width=45% src="./Images/WisataAlamBogor/curugkencana1.png" id="gambar1">
              <img width=23.5% src="./Images/WisataAlamBogor/curugkencana2.png" id="gambar2">
              <img width=23.5% src="./Images/WisataAlamBogor/curugkencana3.png" id="gambar2">
          </div>
          
          <div class id ="caption">
              <div class id="deskripsi">
                  <h1>Curug Cinta Putri Kencana</h1>
                  <h3>Rating 4.4/5 <span id="titik">●</span> Sentul Atas, Karang Tengah, Kec. Babakan Madang, Bogor,</h3>
                  <h4>Buka <span id="titik">●</span> Everyday: 00:01 - 23:59</h4>
                  <h5>Curug Cinta Putri Kencana memiliki air terjun yang tidak terlalu tinggi dengan tinggi sekitar lima meter dengan dua jalur mata air yang mengalir jernih dan deras ke bawah kolam di bawahnya. Namanya sendiri diambil dari aliran air yang menyerupai bentuk hati karena adanya bebatuan yang terbelah di tengah alirannya.</h5>
              </div>
              <div class id="tiket">
                  <h2>Terjual</h2>
